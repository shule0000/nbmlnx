	...
	<nav class="navbar navbar-fixed-top navbar-mlnx" role="navigation">
		<div class="navbar-header">
			<button type="button" class="navbar-toggle" data-toggle="collapse"
				...
				<span class="sr-only">网站导航</span> <span class="icon-bar"></span> <span
		...
		<div class="collapse navbar-collapse" id="index-navbar-collapse">
			<ul class="nav navbar-nav">
				<c:forEach items="${navigations }" var="nav">
					<li><a href="#page${nav.nid }" class="scroll">${nav.navName }</a></li>
				</c:forEach>
			</ul>
		</div>
	</nav>
									...
									<div class="table-middle">
										<div class="table-inner table-right">
											...
											<div class="btn btn-mlnx ">
												更多<span class="glyphicon glyphicon-hand-right mlnx-gt"></span>
											</div>
										</div>
									</div>
								</div>
		...
		<div id="page4" class="page">
			...
			<div class="wrap container page-box">
				...
				<div id="portfolio-filter">
					<ul id="filter">
						<li><a href="#page3" class="current" data-filter="*" title="">全部</a></li>
					...
					<ul id="portfolio" class="portfolio-wrap">
						<c:forEach items="${images }" var="img">
							<c:if test="${img.imgType=='证书类' }">
								<li class="portfolio-box honour"><a class="expander"
							...
							<c:if test="${img.imgType=='人员类' }">
								<li class="portfolio-box member"><a class="expander"
									href="javascript:void(0);" title=""> <img
										src="/docs/upload/${img.imgUrl }" alt="" />
										<div class="mask"></div>
										<h4>${img.imgDetail }</h4>
													...
													<form action="#" method="post" class="send-message">
														...
														<div class="row">
															<div class="text col-md-12">
																<textarea name="text" placeholder="留言"></textarea>
															</div>
														</div>
												...
												<div class="info text-left">
													...
													<ul>
														<c:forEach items="${contact }" var="ct">
															<li><i class="glyphicon glyphicon-earphone"></i><a
																href="tel:${ct.ctPhone }">${ct.ctPhone }</a></li>
															<li><i class="glyphicon glyphicon-globe"></i><a
			...
			<div class="copy">
				<c:forEach items="${copyright }" var="cop">
					<p style="font-size: 10px">
						© 2015 Power by <a href="http://www.nbmlnx.com" target="_blank">${cop.cpDetail }</a>
					</p>
				</c:forEach>
			</div>
		</div>
