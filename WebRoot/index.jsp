  ...
  <div id="page3">
    <div class="col-md-4 service-center">
      ...
      <h1>
        ...
        <p>利用公司信息化、网络化、无线化的优势,实现医疗前（预防、监护）、医疗中与医疗后（随访、个性服务）的医疗健康全过程的跟踪与服务，将医疗服务延伸到院外，整体提升医疗服务水平及和谐医患关系</p>
    </div>
    <div class="col-md-4 service-center">
      <img src="img/service_community.png" alt="service_community" />
      <h1>社区服务</h1>
      <p>提供公司便携式设备，既能对病人的身体状况及时监控，又不限制病人的活动范围和正常生活。</p>
    </div>
    <div class="col-md-4 service-center">
      <img src="img/service_welfare.png" alt="service_welfare" />
      <h1>敬老院服务</h1>
      <p>提供被监护人的健康状况、曾患过的疾病等相关信息，为医护人员的快速响应、SOS紧急求助提供指引</p>
    </div>
  </div>
